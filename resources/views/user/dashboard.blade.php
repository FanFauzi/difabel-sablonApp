            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('user.orders.create', \App\Models\Product::first()?->id ?? 1) }}"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-2">
                                    ...
                                    {{ $latestOrder->product ? $latestOrder->product->name : 'Produk Sablon' }}
                                </p>
                                <p class="mb-2">
                                    <strong>Jumlah:</strong> {{ $latestOrder->quantity }} pcs
                                </p>
                                <p class="mb-2">
                                    <strong>Total:</strong> <span class="text-success fw-bold">Rp
                                        {{ number_format($latestOrder->total_price, 0, ',', '.') }}</span>
                                </p>
                                <small class="text-muted">
                                    <i class="fas fa-calendar me-1"></i>Dipesan:
                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <div class="mb-3">
                                    <span
                                        class="badge bg-{{ $statusColors[$latestOrder->status] ?? 'secondary' }} fs-6 px-4 py-2">
                                        {{ $statusText[$latestOrder->status] ?? ucfirst($latestOrder->status) }}
                                    </span>
                                </div>
                                <a href="{{ route('user.orders.show', $latestOrder->id) }}"
            ...
            <div class="card border-success">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Informasi:</strong> Sistem pembayaran akan diaktifkan setelah pesanan dikonfirmasi oleh
                        admin.
                                ...
                                <tbody>
                                    @foreach (Auth::user()->orders()->latest()->take(5)->get() as $order)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $order->product->name ?? 'Produk Sablon' }}
                                            </td>
                                            <td>
                                                @php
                                                    $statusColors = [
