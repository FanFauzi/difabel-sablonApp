                            ...
                            <div class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb-3">
                                        <label for="name" class="form-label fw-bold"><i
                                                class="fas fa-tag text-info me-1"></i>Nama Produk</label>
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ old('name', $product->name) }}" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="category" class="form-label fw-bold"><i
                                                class="fas fa-list text-info me-1"></i>Kategori</label>
                                        <select class="form-control" id="category" name="category" required>
                                            ...
                                            <option value="kemeja"
                                                {{ old('category', $product->category) == 'kemeja' ? 'selected' : '' }}>
                                                Kemeja</option>
                                            <option value="jaket"
                                                {{ old('category', $product->category) == 'jaket' ? 'selected' : '' }}>Jaket
                                            </option>
                                            <option value="topi"
                                                {{ old('category', $product->category) == 'topi' ? 'selected' : '' }}>Topi
                                            </option>
                                            {{-- Penambahan Kategori Tas --}}
                                            <option value="tas"
                                                {{ old('category', $product->category) == 'tas' ? 'selected' : '' }}>Tas
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="description" class="form-label fw-bold"><i
                                                class="fas fa-file-alt text-info me-1"></i>Deskripsi</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="price" class="form-label fw-bold"><i
                                                class="fas fa-money-bill-wave text-info me-1"></i>Harga (Rp)</label>
                                        <input type="number" class="form-control" id="price" name="price"
                                            value="{{ old('price', $product->price) }}" required min="1000">
                                    </div>
                                    {{-- Penambahan Input Stok --}}
                                    <div class="col-md-6 mb-3">
                                        <label for="stock" class="form-label fw-bold"><i
                                                class="fas fa-boxes text-info me-1"></i>Stok</label>
                            ...
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="large_design_cost" class="form-label fw-bold">Biaya Sablon A3
                                                <span class="text-muted small">(Max 29x42 cm)</span></label>
                                            <div class="input-group">
                                                <span class="input-group-text">Rp</span>
                                ...
                                @if ($product->image)
                                    <div class="mt-3">
                                        ...
                                        <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}"
                                            class="img-thumbnail rounded" style="max-width: 250px;">
                                    </div>
                                @endif
                            </div>
