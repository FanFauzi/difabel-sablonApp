                        ...
                        <tbody>
                            @forelse($customProducts as $product)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <div class="fw-bold">{{ $product->name }}</div><small
                                    ...
                                    <td>
                                        @if ($product->slug)
                                            <span class="badge bg-primary"><i class="fas fa-paint-brush me-1"></i> Desain
                                                Kustom</span>
                                        @else
                                            <span class="badge bg-secondary"><i class="fas fa-tshirt me-1"></i> Produk
                                                Jadi</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <div class="small">
                                            <div><small>S: Rp
                                                    {{ number_format($product->small_design_cost, 0, ',', '.') }}</small>
                                            </div>
                                            <div><small>M: Rp
                                                    {{ number_format($product->medium_design_cost, 0, ',', '.') }}</small>
                                            </div>
                                            <div><small>L: Rp
                                                    {{ number_format($product->large_design_cost, 0, ',', '.') }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.products.edit', $product->id) }}"
                                                class="btn btn-sm btn-outline-primary" title="Edit Produk"><i
                                                    class="fas fa-edit"></i></a>
                                            <a href="{{ route('admin.products.delete', $product->id) }}"
                                                class="btn btn-sm btn-outline-danger" title="Hapus Produk"><i
                            ...
                            @empty
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-4"><i
                                            class="fas fa-tshirt fa-3x text-muted mb-3"></i>
                                        <p class="text-muted mb-0">Tidak ada produk ditemukan.</p><a
                                            href="{{ route('admin.products.create') }}" class="btn btn-primary mt-3"><i
                                                class="fas fa-plus me-2"></i>Tambah Produk Pertama</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
