...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card shadow-lg border-0 h-100"
                    style="border-radius: 15px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card shadow-lg border-0 h-100"
                    style="border-radius: 15px; background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <div class="text-white-50 small mb-1">LOG AKTIVITAS</div>
                                <div class="h2 text-white mb-0 font-weight-bold">{{ \App\Models\ActivityLog::count() }}
                                </div>
                            </div>
                            <div class="bg-white bg-opacity-20 rounded-circle p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-3">
                                <div class="card bg-gradient-info text-white border-0"
                                    style="border-radius: 12px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                                    <div class="card-body text-center p-4">
                                        <div class="display-4 mb-2">
                                            {{ \App\Models\Order::where('status', 'proses')->count() }}</div>
                            ...
                            <div class="col-sm-4 mb-3">
                                <div class="card bg-gradient-success text-white border-0"
                                    style="border-radius: 12px; background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
                                    <div class="card-body text-center p-4">
                                        <div class="display-4 mb-2">
                                            {{ \App\Models\Order::where('status', 'selesai')->count() }}</div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card shadow-lg border-0 h-100" style="border-radius: 15px;">
                    <div class="card-header bg-gradient-success text-white"
                        style="border-radius: 15px 15px 0 0 !important; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
                        <h5 class="mb-0">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <div class="h3 mb-0 text-success font-weight-bold">
                                Rp
                                {{ number_format(\App\Models\Order::where('status', 'selesai')->sum('total_price'), 0, ',', '.') }}
                            </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    ...
                                                    <p class="text-muted small mb-0">
                                                        {{ $log->description ?? 'Aktivitas sistem' }}</p>
                                                </div>
