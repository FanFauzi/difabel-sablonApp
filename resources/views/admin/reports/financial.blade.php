    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('admin.reports.financial.export.excel') }}" class="btn btn-success">Export to Excel</a>
                <a href="{{ route('admin.reports.financial.export.pdf') }}" class="btn btn-danger">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    Rp
                                    {{ $totalOrders > 0 ? number_format($totalIncome / $totalOrders, 0, ',', '.') : '0' }}
                                </div>
                                <div class="text-xs text-muted mt-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-muted">
                                                    Rp
                                                    {{ $report['total_orders'] > 0 ? number_format($report['income'] / $report['total_orders'], 0, ',', '.') : '0' }}
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
    ...
    <script>
        function generateReport() {
            ...
            if (period === 'daily') {
                ...
                document.getElementById('monthlyReportTable').parentElement.parentElement.parentElement.style.display =
                    'none';
            } else {
