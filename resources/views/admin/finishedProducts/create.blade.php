        ...
        <div class="col-lg-8">
            <div class="card shadow-lg border-0" style="border-radius: 15px;">
                ...
                <div class="card-body p-4">
                    {{-- Ganti 'products.store' dengan route yang sesuai di controller Anda --}}
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                        @csrf

                        <div class="mb-4">
                            <h6 class="text-primary fw-bold mb-3"><i class="fas fa-info-circle me-2"></i>Informasi Dasar</h6>
                            <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Jelaskan detail produk, bahan, ukuran, dan keunggulannya.">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            <h6 class="text-primary fw-bold mb-3"><i class="fas fa-shopping-cart me-2"></i>Penjualan</h6>
                            <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control form-control-lg @error('ecommerce_link') is-invalid @enderror"
                        ...
                        <div class="mb-4">
                            ...
                            <div id="imagePreview" class="d-none mt-3 text-center">
                                <img id="previewImg" src="#" alt="Preview Gambar" class="img-fluid rounded" style="max-height: 250px; border: 2px dashed #ddd; padding: 5px;" />
