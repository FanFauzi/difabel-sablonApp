...
<body>
    <div class="d-flex">
        <!-- Sidebar -->
        <nav class="sidebar bg-dark text-white position-fixed" id="userSidebar" style="width: 220px; height: 100vh; overflow-y: auto; z-index: 1000;">
            <div class="p-2">
                ...
                <div class="user-profile mb-3 p-3 bg-gradient-primary text-center rounded">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="text-white-75" style="font-size: 0.75rem;">{{ Str::limit(Auth::user()->email, 20) }}</div>
                    </div>
                ...
                <!-- Main Menu -->
                <div class="mb-3">
                    <div class="menu-title text-uppercase small fw-bold text-white-75 mb-2 px-2" style="font-size: 0.7rem;">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <form action="{{ route('logout') }}" method="POST" class="d-inline w-100">
                                @csrf
                                <button type="submit" class="nav-link logout-link text-white bg-transparent border-0 text-start w-100 p-2">
