...
<body>
    <div class="d-flex">
        <!-- Sidebar -->
        <nav class="sidebar bg-dark text-white" id="sidebar" style="width: 240px; min-height: 100vh; position: fixed; left: 0; top: 0; z-index: 1000; overflow-y: auto;">
                ...
                <div class="sidebar-nav px-2 py-1">
                    ...
                    <div class="nav-section mb-2">
                        ...
                        <a class="nav-link {{ request()->routeIs('users.*') ? 'active' : '' }}" href="{{ route('users.index') }}">
                            ...
                            <div class="nav-badge">
                                <span class="badge bg-primary" style="font-size: 0.6rem; padding: 2px 6px;">{{ \App\Models\User::count() }}</span>
                            </div>
                        </a>
                        ...
                        <a class="nav-link {{ request()->routeIs('products.*') ? 'active' : '' }}" href="{{ route('products.index') }}">
                            ...
                            <div class="nav-badge">
                                <span class="badge bg-success" style="font-size: 0.6rem; padding: 2px 6px;">{{ \App\Models\Product::count() }}</span>
                            </div>
                        </a>
                        ...
                        <a class="nav-link {{ request()->routeIs('orders.*') ? 'active' : '' }}" href="{{ route('orders.index') }}">
                            ...
                            <div class="nav-badge">
                                <span class="badge bg-warning" style="font-size: 0.6rem; padding: 2px 6px;">{{ \App\Models\Order::count() }}</span>
                            </div>
                        </a>
                    </div>
    ...
    .nav-section:nth-child(2) .nav-link:nth-child(2) { animation-delay: 0.25s; }
    .nav-section:nth-child(2) .nav-link:nth-child(3) { animation-delay: 0.3s; }
    .nav-section:nth-child(2) .nav-link:nth-child(4) { animation-delay: 0.35s; }
    .nav-section:nth-child(3) .nav-link:nth-child(1) { animation-delay: 0.4s; }
    .nav-section:nth-child(3) .nav-link:nth-child(2) { animation-delay: 0.45s; }
    .nav-section:nth-child(4) .nav-link:nth-child(1) { animation-delay: 0.5s; }
